            ...
            <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="form-create" class="forms-sample" action="{{ route('jurusan_edit_proses') }}" method="POST">
                      @csrf
                    <input type="hidden" name="id" value="{{ $item->id }}">
                        ...
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Nama jurusan</label>
                          <div class="col-sm-9">
                            <div class="">
                               ...
                               <input class="form-control form-control-sm" type="text" required name="nama_jurusan" value="{{ $item->nama_jurusan }}" >
                            </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <select class="form-select form-select-sm" aria-label="Default select example" name="kampus_id">
                            <option selected>pilih salah satu kampus</option>
                      ...
                      <div class="pt-lg-3 pt-3">
                        <button type="button" class="btn btn-primary btn-sm " onclick="showAlertCreate({{ $item->id }})">Submit</button>
