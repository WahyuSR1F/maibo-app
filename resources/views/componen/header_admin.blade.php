    ...
    <nav class="navbar bg-primary navbar-dark  p-0 fixed-top d-flex align-items-top flex-row shadow-lg">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          ...
          <div class="" width=50 height=100 >
           <a class=" navbar-brand brand-logo img-fluid" href="{{ route('dasboard_admin') }}">
              <img width=50 height=100 src="{{ asset('assets/img/logomaibo.png') }}" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini img-fluid "  href="{{ route('dasboard_admin') }}">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top bg-primary justify-content-sm-start"> 
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0 ">
             <h1 class="welcome-text text-white">Hello, <span class="text-white fw-bold">{{ $allData['email'] }}</span></h1>
            </li>
          </ul>
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-dropdown">
              <a class="nav-link count-indicator" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle" src="{{ $allData['foto'] }}" alt="Profile image"> </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-xs rounded-circle" src="{{ $allData['foto'] }}" alt="Profile image">
                  <p class="mb-1 mt-3 font-weight-semibold">Admin</p>
                  <p class="fw-light text-muted mb-0">{{ $allData['email']}}</p>
                </div>
                <a class="dropdown-item" href="{{ route('profile_view') }}"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My Profile</a>
